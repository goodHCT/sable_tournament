...
public class InstantExplosiveMediumBlock extends AbstractExplosiveBlock {
    public static final MapCodec<InstantExplosiveMediumBlock> CODEC = simpleCodec(properties -> new InstantExplosiveMediumBlock());
    ...
    public InstantExplosiveMediumBlock() {
        super();
    }
